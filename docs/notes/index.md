...
* Pricing & Packaging: [pricing_packaging](../monetization/pricing_packaging.md)
* Snapshot (автогенерация в CI): [_snapshot](../_snapshot.md)
...
* Pricing & Packaging:
    * Pages: `monetization/pricing_packaging/`
    * Raw: `https://raw.githubusercontent.com/AngorSTV/Project/main/docs/monetization/pricing_packaging.md`
